        ...
        <div class="row"><!-- row Begin -->
            <div class="col-sm-6 col-md-3"><!-- col-sm-6 col-md-3 Begin -->
               ...
               <h4>Pages</h4>
                ...
                <ul><!-- ul Begin -->
                    ...
                    <li><a href="chatbot.php">chat</a></li>
            ...
            <div class="col-sm-6 col-md-3"><!-- col-sm-6 col-md-3 Begin -->
                ...
                <p><!-- p Start -->
                    ...
                    <strong>Shohan.</strong>
                    <br/>Dhaka
                    <br/>Bangladesh
                    <br/>01632203312
                    <br/>shohan8ahmed@gmail.com
                    <br/><strong>Shohan</strong>
...
<div id="copyright"><!-- #copyright Begin -->
    <div class="container"><!-- container Begin -->
        <div class="col-md-6"><!-- col-md-6 Begin -->
            ...
            <p class="pull-left">&copy; 2018 to 2022</p>
            
        </div><!-- col-md-6 Finish -->
        <div class="col-md-6"><!-- col-md-6 Begin -->
            
            <p class="pull-right">Theme by: <a href="#">Shohan</a></p>
